        ...
        {platforms.map((p) => {
          ...
          return (
            <a
              ...
              className="bg-white/3 border border-white/10 p-6 rounded-2xl flex items-center space-x-4 hover:-translate-y-1 hover:border-white/40 transition-all duration-300"
            >
